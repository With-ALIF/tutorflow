...
export const ExpenseTableRow: React.FC<ExpenseTableRowProps> = ({ expense, student, onEdit, onDelete }) => {
  ...
  return (
    <tr className="transition-colors group text-slate-900 dark:text-white border-b border-slate-50 dark:border-slate-800">
      <td className="px-6 py-4">
        <p className="font-bold transition-colors">{expense.title}</p>
