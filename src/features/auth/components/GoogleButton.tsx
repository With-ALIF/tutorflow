...
export const GoogleButton: React.FC<GoogleButtonProps> = ({ onClick, loading }) => {
  return (
    <button
      ...
      onClick={onClick}
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border border-slate-200 rounded-2xl font-medium text-[#3c4043] hover:bg-slate-50 transition-all shadow-sm disabled:opacity-50"
    >
