      ...
      <div className="p-4">
        <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-2xl border border-slate-200 dark:border-white/5 backdrop-blur-sm">
          ...
          {isAuthenticated ? (
            ...
            <Link 
              to="/login"
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-indigo-600 text-white text-xs font-bold rounded-xl transition-all shadow-lg shadow-indigo-600/20 hover:bg-indigo-700"
            >
